set moduleName proc_1_1_Pipeline_VITIS_LOOP_47_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {proc_1_1_Pipeline_VITIS_LOOP_47_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ p_phi_reload int 32 regular  }
	{ data_channel23 int 32 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p_phi_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ p_phi_reload sc_in sc_lv 32 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_phi_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "p_phi_reload", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	p_phi_reload { ap_none {  { p_phi_reload in_data 0 32 } } }
