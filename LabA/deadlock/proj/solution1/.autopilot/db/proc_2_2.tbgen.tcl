...
set portList { 
	...
	{ data_channel12_num_data_valid sc_in sc_lv 5 signal 1 } 
	{ data_channel12_fifo_cap sc_in sc_lv 5 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "data_channel12", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "10", "DependentChanType" : "0",
				"BlockSignal" : [
