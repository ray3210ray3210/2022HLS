...
// ==============================================================
#ifndef example_fifo_w32_d10_S_x_HH_
#define example_fifo_w32_d10_S_x_HH_

#include <systemc>
using namespace std;
SC_MODULE(example_fifo_w32_d10_S_x) {
    static const unsigned int DATA_WIDTH = 32;
    static const unsigned int ADDR_WIDTH = 4;
    static const unsigned int example_fifo_w32_d10_S_x_depth = 11;
    ...
    sc_core::sc_signal< sc_dt::sc_lv<DATA_WIDTH> >  mStorage[example_fifo_w32_d10_S_x_depth];
    ...
    SC_CTOR(example_fifo_w32_d10_S_x) : mTrace(0) {
        ...
        SC_METHOD(proc_dout);
        sensitive << mOutPtr;
        for (unsigned i = 0; i < example_fifo_w32_d10_S_x_depth; i++) {
        ...
        if (reset.read() == sc_dt::SC_LOGIC_1) {
            ...
            if (if_read_ce.read() == sc_dt::SC_LOGIC_1
               ...
               && internal_empty_n.read() == sc_dt::SC_LOGIC_1) {
                ...
                if (mOutPtr.read().to_uint() == (example_fifo_w32_d10_S_x_depth-1)) {
                    ptr = 0;
                ...
                assert(ptr.to_uint() < example_fifo_w32_d10_S_x_depth);
                mOutPtr.write(ptr);
            }
            if (if_write_ce.read() == sc_dt::SC_LOGIC_1
                ...
                if (ptr.to_uint() == (example_fifo_w32_d10_S_x_depth-1)) {
                    ptr = 0;
                    mFlag_nEF_hint.write(~mFlag_nEF_hint.read());
                } else {
                    ptr++;
    ...
    void proc_dout() {
        ...
        if (ptr.to_uint() > example_fifo_w32_d10_S_x_depth) {
...
#endif //example_fifo_w32_d10_S_x_HH_
