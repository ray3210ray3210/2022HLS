...
module example_proc_1_2_Pipeline_VITIS_LOOP_56_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln56_fu_86_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln56_fu_86_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln56_fu_86_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((data_channel12_full_n == 1'b0) | (data_channel121_empty_n == 1'b0) | (data_channel232_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((data_channel12_full_n == 1'b0) | (data_channel121_empty_n == 1'b0) | (data_channel232_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((data_channel12_full_n == 1'b0) | (data_channel121_empty_n == 1'b0) | (data_channel232_empty_n == 1'b0)));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((data_channel12_full_n == 1'b0) | (data_channel121_empty_n == 1'b0) | (data_channel232_empty_n == 1'b0));
end
...
assign data_channel12_din = (data_channel121_dout + data_channel232_dout);

assign i_9_fu_92_p2 = (ap_sig_allocacmp_i_8 + 4'd1);

assign icmp_ln56_fu_86_p2 = ((ap_sig_allocacmp_i_8 == 4'd10) ? 1'b1 : 1'b0);

assign tmp_8_fu_103_p2 = (data_channel121_dout + data_channel232_dout);

endmodule //example_proc_1_2_Pipeline_VITIS_LOOP_56_1
