...
architecture behav of example is 
    ...
    "example_example,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7v585t-ffg1761-2,HLS_INPUT_CLOCK=13.333000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=6.507000,HLS_SYN_LAT=34,HLS_SYN_TPT=29,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=766,HLS_SYN_LUT=1333,HLS_VERSION=2022_1}";
    ...
    signal data_channel1_num_data_valid : STD_LOGIC_VECTOR (4 downto 0);
    signal data_channel1_fifo_cap : STD_LOGIC_VECTOR (4 downto 0);
