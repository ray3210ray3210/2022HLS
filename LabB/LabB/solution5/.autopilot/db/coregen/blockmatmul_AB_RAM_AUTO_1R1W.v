...
module blockmatmul_AB_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 512,
    EnableWidth  = 64,
    AddressRange = 32,
    ...
    input  wire                    i_ce0,
    input  wire [EnableWidth-1:0]  i_we0,
    input  wire [AddressWidth-1:0] i_address0,
    input  wire [DataWidth-1:0]    i_d0,
    output wire [DataWidth-1:0]    i_q0,
    input  wire                    i_ce1,
    input  wire [EnableWidth-1:0]  i_we1,
    ...
    input  wire                    t_ce0,
    input  wire [EnableWidth-1:0]  t_we0,
    input  wire [AddressWidth-1:0] t_address0,
    input  wire [DataWidth-1:0]    t_d0,
    output wire [DataWidth-1:0]    t_q0,
    input  wire                    t_ce1,
    input  wire [EnableWidth-1:0]  t_we1,
...
wire [EnableWidth-1:0]  buf_we0[0:BufferCount-1];
...
wire [EnableWidth-1:0]  buf_we1[0:BufferCount-1];
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        blockmatmul_AB_RAM_AUTO_1R1W_memcore blockmatmul_AB_RAM_AUTO_1R1W_memcore_U (
            .clk      ( clk ),
            .reset    ( reset ),
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
