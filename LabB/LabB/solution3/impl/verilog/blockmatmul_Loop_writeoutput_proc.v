...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_224)) begin
        if ((icmp_ln33_fu_331_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln33_fu_331_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign ABpartial_d0 = tmp_s_reg_616;
...
assign add_ln35_fu_448_p2 = (tmp_fu_438_p3 + zext_ln35_fu_445_p1);
...
assign tmp_fu_438_p3 = {{trunc_ln35_reg_526}, {4'd0}};
