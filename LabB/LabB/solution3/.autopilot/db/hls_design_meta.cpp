...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("ABpartial_address1", 8, hls_out, 2, "ap_memory", "mem_address", 1),
	Port_Property("ABpartial_ce1", 1, hls_out, 2, "ap_memory", "mem_ce", 1),
	Port_Property("ABpartial_d1", 32, hls_out, 2, "ap_memory", "mem_din", 1),
	Port_Property("ABpartial_q1", 32, hls_in, 2, "ap_memory", "mem_dout", 1),
	Port_Property("ABpartial_we1", 1, hls_out, 2, "ap_memory", "mem_we", 1),
