set SynModuleInfo {
  ...
  {SRCNAME Loop_1_proc1_Pipeline_ps_i MODELNAME Loop_1_proc1_Pipeline_ps_i RTLNAME blockmatmul_Loop_1_proc1_Pipeline_ps_i
    SUBMODULES {
  ...
  {SRCNAME Loop_1_proc1 MODELNAME Loop_1_proc1 RTLNAME blockmatmul_Loop_1_proc1
    SUBMODULES {
      {MODELNAME blockmatmul_Loop_1_proc1_A_RAM_AUTO_1R1W RTLNAME blockmatmul_Loop_1_proc1_A_RAM_AUTO_1R1W BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
    }
  }
  {SRCNAME Loop_writeoutput_proc MODELNAME Loop_writeoutput_proc RTLNAME blockmatmul_Loop_writeoutput_proc
    SUBMODULES {
      {MODELNAME blockmatmul_mux_165_32_1_1 RTLNAME blockmatmul_mux_165_32_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
