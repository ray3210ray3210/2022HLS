...
$(ObjDir)/BlockBatrix_testbench.cpp_pre.cpp.tb.o : BlockBatrix_testbench.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling BlockBatrix_testbench.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/BlockMatrix_design.cpp_pre.cpp.tb.o : BlockMatrix_design.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling BlockMatrix_design.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
