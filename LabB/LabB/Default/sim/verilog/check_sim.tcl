...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.blockmatmul.autotvin_Arows.dat"
         "c.blockmatmul.autotvin_Bcols.dat"
         "c.blockmatmul.autotvin_ABpartial.dat"
         "c.blockmatmul.autotvin_it.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.blockmatmul.autotvout_ABpartial.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
