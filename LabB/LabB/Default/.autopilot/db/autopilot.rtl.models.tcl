set SynModuleInfo {
  ...
  {SRCNAME blockmatmul_Pipeline_partialsum MODELNAME blockmatmul_Pipeline_partialsum RTLNAME blockmatmul_blockmatmul_Pipeline_partialsum
    SUBMODULES {
  ...
  {SRCNAME blockmatmul MODELNAME blockmatmul RTLNAME blockmatmul IS_TOP 1
    SUBMODULES {
      {MODELNAME blockmatmul_A_0_RAM_AUTO_1R1W RTLNAME blockmatmul_A_0_RAM_AUTO_1R1W BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
