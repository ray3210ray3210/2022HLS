; ModuleID = 'E:/Xilinx/Vitis/LabB/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_blockmatmul_ir(%"class.hls::stream<blockvec, 0>"* noalias nocapture nonnull dereferenceable(16) %Arows, %"class.hls::stream<blockvec, 0>"* noalias nocapture nonnull dereferenceable(16) %Bcols, %struct.blockmat* noalias nocapture nonnull dereferenceable(64) %ABpartial, i32 %it) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_blockmatmul_hw(i128* %Arows_copy, i128* %Bcols_copy, i512* %ABpartial_copy, i32 %it)
...
declare void @apatb_blockmatmul_hw(i128*, i128*, i512*, i32)
...
define void @blockmatmul_hw_stub_wrapper(i128*, i128*, i512*, i32) #8 {
entry:
