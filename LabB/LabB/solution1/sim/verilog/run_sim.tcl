...
if {[file isfile blockmatmul.autotvin.dat]} {
	file delete -force blockmatmul.autotvin.dat
}

if {[file isfile blockmatmul.autotvout.dat]} {
	file delete -force blockmatmul.autotvout.dat
}
