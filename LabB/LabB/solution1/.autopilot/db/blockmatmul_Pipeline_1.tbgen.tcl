...
set C_modelArgList {
	{ AB int 32 regular {array 256 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ AB_address0 sc_out sc_lv 8 signal 0 } 
...
set Spec2ImplPortList { 
	AB { ap_memory {  { AB_address0 mem_address 1 8 }  { AB_ce0 mem_ce 1 1 }  { AB_we0 mem_we 1 1 }  { AB_d0 mem_din 1 32 } } }
}
